...
function GetPagination($p,$totalPage,$pagenum,$mode='LEFT',$link=null) {
	...
	if ($prevPageStart === null) {
		...
		if ($link === null) $html.= '<a href="'.($prevPage !== false ? $IM->getUrl(null,null,null,$prevPage).$IM->getQueryString() : '#').'">';
		elseif (preg_match('/^@/',$link) == true) $html.= '<a href="javascript:void(0);" onclick="return '.preg_replace('/^@/','',$link).'('.($prevPage !== false ? $prevPage : 'null').',this);">';
		elseif (preg_match('/^#/',$link) == true) $html.= '<a href="'.$link.($prevPage !== false ? $prevPage : '0').'">';
		...
		if ($link === null) $html.= '<a href="'.($prevPageStart !== false ? $IM->getUrl(null,null,null,$prevPageStart).$IM->getQueryString() : '#').'">';
		elseif (preg_match('/^@/',$link) == true) $html.= '<a href="javascript:void(0);" onclick="return '.preg_replace('/^@/','',$link).'('.($prevPageStart !== false ? $prevPageStart : 'null').',this);">';
		elseif (preg_match('/^#/',$link) == true) $html.= '<a href="'.$link.($prevPageStart !== false ? $prevPageStart : '0').'">';
	...
	for ($i=$startPage;$i<=$endPage;$i++) {
		...
		if ($link === null) $html.= '<a href="'.$IM->getUrl(null,null,null,$i).$IM->getQueryString().'">';
		elseif (preg_match('/^@/',$link) == true) $html.= '<a href="javascript:void(0);" onclick="return '.preg_replace('/^@/','',$link).'('.$i.',this);">';
		elseif (preg_match('/^#/',$link) == true) $html.= '<a href="'.$link.$i.'">';
	...
	if ($nextPageStart === null) {
		...
		if ($link === null) $html.= '<a href="'.($nextPage !== false ? $IM->getUrl(null,null,null,$nextPage).$IM->getQueryString() : '#').'">';
		elseif (preg_match('/^@/',$link) == true) $html.= '<a href="javascript:void(0);" onclick="return '.preg_replace('/^@/','',$link).'('.($nextPage !== false ? $nextPage : 'null').',this);">';
		elseif (preg_match('/^#/',$link) == true) $html.= '<a href="'.$link.($nextPage !== false ? $nextPage : '0').'">';
		...
		if ($link === null) $html.= '<a href="'.($nextPageStart !== false ? $IM->getUrl(null,null,null,$nextPageStart).$IM->getQueryString() : '#').'">';
		elseif (preg_match('/^@/',$link) == true) $html.= '<a href="javascript:void(0);" onclick="return '.preg_replace('/^@/','',$link).'('.($nextPageStart !== false ? $nextPageStart : 'null').',this);">';
		elseif (preg_match('/^#/',$link) == true) $html.= '<a href="'.$link.($nextPageStart !== false ? $nextPageStart : '0').'">';
