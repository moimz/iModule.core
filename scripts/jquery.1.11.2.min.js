...
b.gotoYear(a.value))};b._onKeyChange=function(a){a=a||window.event;if(b.isVisible())switch(a.keyCode){case 13:case 27:c.field.blur();break;case 37:a.preventDefault();b.adjustDate("subtract",1);break;case 38:b.adjustDate("subtract",7);break;case 39:b.adjustDate("add",1);break;case 40:b.adjustDate("add",7)}};b._onInputChange=function(a){a.firedBy!==b&&(a=p?(a=n(c.field.value,c.format,c.formatStrict))&&a.isValid()?a.toDate():null:new Date(Date.parse(c.field.value)),h(a)&&b.setDate(a),b._v||b.show())};
...
b.hide()}};b.el=g.createElement("div");b.el.className="pika-single"+(c.isRTL?" is-rtl":"")+(c.theme?" "+c.theme:"");r(b.el,"mousedown",b._onMouseDown,!0);r(b.el,"touchend",b._onMouseDown,!0);r(b.el,"change",b._onChange);r(g,"keydown",b._onKeyChange);c.field&&(c.container?c.container.appendChild(b.el):c.bound?g.body.appendChild(b.el):c.field.parentNode.insertBefore(b.el,c.field.nextSibling),r(c.field,"change",b._onInputChange),c.defaultDate||(c.defaultDate=p&&c.field.value?n(c.field.value,c.format).toDate():
new Date(Date.parse(c.field.value)),c.setDefaultDate=!0));a=c.defaultDate;h(a)?c.setDefaultDate?b.setDate(a,!0):b.gotoDate(a):b.gotoDate(new Date);c.bound?(this.hide(),b.el.className+=" is-bound",r(c.trigger,"click",b._onInputClick),r(c.trigger,"focus",b._onInputFocus),r(c.trigger,"blur",b._onInputBlur)):this.show()};G.prototype={config:function(a){this._o||(this._o=y({},t,!0));a=y(this._o,a,!0);a.isRTL=!!a.isRTL;a.field=a.field&&a.field.nodeName?a.field:null;a.theme="string"===typeof a.theme&&a.theme?
a.theme:null;a.bound=!!(void 0!==a.bound?a.field&&a.bound:a.field);a.trigger=a.trigger&&a.trigger.nodeName?a.trigger:a.field;a.disableWeekends=!!a.disableWeekends;a.disableDayFn="function"===typeof a.disableDayFn?a.disableDayFn:null;var b=parseInt(a.numberOfMonths,10)||1;a.numberOfMonths=4<b?4:b;h(a.minDate)||(a.minDate=!1);h(a.maxDate)||(a.maxDate=!1);a.minDate&&a.maxDate&&a.maxDate<a.minDate&&(a.maxDate=a.minDate=!1);a.minDate&&this.setMinDate(a.minDate);a.maxDate&&this.setMaxDate(a.maxDate);A(a.yearRange)?
(b=(new Date).getFullYear()-10,a.yearRange[0]=parseInt(a.yearRange[0],10)||b,a.yearRange[1]=parseInt(a.yearRange[1],10)||b):(a.yearRange=Math.abs(parseInt(a.yearRange,10))||t.yearRange,100<a.yearRange&&(a.yearRange=100));return a},toString:function(a){return h(this._d)?p?n(this._d).format(a||this._o.format):this._d.toDateString():""},getMoment:function(){return p?n(this._d):null},setMoment:function(a,b){p&&n.isMoment(a)&&this.setDate(a.toDate(),b)},getDate:function(){return h(this._d)?new Date(this._d.getTime()):
new Date},setDate:function(a,b){if(!a)return this._d=null,this._o.field&&(this._o.field.value="",C(this._o.field,"change",{firedBy:this})),this.draw();"string"===typeof a&&(a=new Date(Date.parse(a)));if(h(a)){var c=this._o.minDate,d=this._o.maxDate;h(c)&&a<c?a=c:h(d)&&a>d&&(a=d);this._d=new Date(a.getTime());D(this._d);this.gotoDate(this._d);this._o.field&&(this._o.field.value=this.toString(),C(this._o.field,"change",{firedBy:this}));b||"function"!==typeof this._o.onSelect||this._o.onSelect.call(this,
...
adjustDate:function(a,b){var c=this.getDate(),d=864E5*parseInt(b),e;"add"===a?e=new Date(c.valueOf()+d):"subtract"===a&&(e=new Date(c.valueOf()-d));p&&("add"===a?e=n(c).add(b,"days").toDate():"subtract"===a&&(e=n(c).subtract(b,"days").toDate()));this.setDate(e)},adjustCalendars:function(){this.calendars[0]=F(this.calendars[0]);for(var a=1;a<this._o.numberOfMonths;a++)this.calendars[a]=F({month:this.calendars[0].month+a,year:this.calendars[0].year});this.draw()},gotoToday:function(){this.gotoDate(new Date)},
...
g=b.maxMonth;a="";this._y<=c&&(this._y=c,!isNaN(e)&&this._m<e&&(this._m=e));this._y>=d&&(this._y=d,!isNaN(g)&&this._m>g&&(this._m=g));c="pika-title-"+Math.random().toString(36).replace(/[^a-z]+/g,"").substr(0,2);for(d=0;d<b.numberOfMonths;d++)a+='<div class="pika-lendar">'+P(this,d,this.calendars[d].year,this.calendars[d].month,this.calendars[0].year,c)+this.render(this.calendars[d].year,this.calendars[d].month,c)+"</div>";this.el.innerHTML=a;b.bound&&"hidden"!==b.field.type&&B(function(){b.trigger.focus()},
1);if("function"===typeof this._o.onDraw)this._o.onDraw(this);this._o.field.setAttribute("aria-label","Use the arrow keys to pick a date")}},adjustPosition:function(){var a,b,c,d,e,k,f,h,m;if(!this._o.container){this.el.style.position="absolute";b=a=this._o.trigger;c=this.el.offsetWidth;d=this.el.offsetHeight;e=window.innerWidth||g.documentElement.clientWidth;k=window.innerHeight||g.documentElement.clientHeight;f=window.pageYOffset||g.body.scrollTop||g.documentElement.scrollTop;if("function"===typeof a.getBoundingClientRect)b=
a.getBoundingClientRect(),h=b.left+window.pageXOffset,m=b.bottom+window.pageYOffset;else for(h=b.offsetLeft,m=b.offsetTop+b.offsetHeight;b=b.offsetParent;)h+=b.offsetLeft,m+=b.offsetTop;if(this._o.reposition&&h+c>e||-1<this._o.position.indexOf("right")&&0<h-c+a.offsetWidth)h=h-c+a.offsetWidth;if(this._o.reposition&&m+d>k+f||-1<this._o.position.indexOf("top")&&0<m-d-a.offsetHeight)m=m-d-a.offsetHeight;this.el.style.left=h+"px";this.el.style.top=m+"px"}},render:function(a,b,c){var d=this._o,e=new Date,
g=K(a,b),f=(new Date(a,b,1)).getDay(),k=[],m=[];D(e);0<d.firstDay&&(f-=d.firstDay,0>f&&(f+=7));for(var l=0===b?11:b-1,n=11===b?0:b+1,p=0===b?a-1:a,r=11===b?a+1:a,t=K(p,l),q=g+f,u=q;7<u;)u-=7;for(var q=q+(7-u),w=u=0;u<q;u++){var v=new Date(a,b,1+(u-f)),y=h(this._d)?E(v,this._d):!1,B=E(v,e),A=u<f||u>=g+f,H=1+(u-f),I=b,J=a,C=d.startRange&&E(d.startRange,v),F=d.endRange&&E(d.endRange,v),G=d.startRange&&d.endRange&&d.startRange<v&&v<d.endRange,z;!(z=d.minDate&&v<d.minDate||d.maxDate&&v>d.maxDate)&&(z=
d.disableWeekends)&&(z=v.getDay(),z=0===z||6===z);v=z||d.disableDayFn&&d.disableDayFn(v);A&&(u<f?(H=t+H,I=l,J=p):(H-=g,I=n,J=r));m.push(M({day:H,month:I,year:J,isSelected:y,isToday:B,isDisabled:v,isEmpty:A,isStartRange:C,isEndRange:F,isInRange:G,showDaysInNextAndPreviousMonths:d.showDaysInNextAndPreviousMonths}));7===++w&&(d.showWeekNumber&&m.unshift(N(u-f,b,a)),k.push(O(m,d.isRTL)),m=[],w=0)}b=[];d.showWeekNumber&&b.push("<th></th>");for(a=0;7>a;a++)b.push('<th scope="col"><abbr title="'+L(d,a)+
'">'+L(d,a,!0)+"</abbr></th>");d="<thead><tr>"+(d.isRTL?b.reverse():b).join("")+"</tr></thead>";return'<table cellpadding="0" cellspacing="0" class="pika-table" role="grid" aria-labelledby="'+c+'">'+d+("<tbody>"+k.join("")+"</tbody>")+"</table>"},isVisible:function(){return this._v},show:function(){if(!this.isVisible()){var a=this.el,b;b=(" "+a.className+" ").replace(" is-hidden "," ");b=b.trim?b.trim():b.replace(/^\s+|\s+$/g,"");a.className=b;this._v=!0;this.draw();this._o.bound&&(r(g,"click",this._onClick),
this.adjustPosition());"function"===typeof this._o.onOpen&&this._o.onOpen.call(this)}},hide:function(){var a=this._v;if(!1!==a){this._o.bound&&w(g,"click",this._onClick);this.el.style.position="static";this.el.style.left="auto";this.el.style.top="auto";var b=this.el;k(b,"is-hidden")||(b.className=""===b.className?"is-hidden":b.className+" is-hidden");this._v=!1;void 0!==a&&"function"===typeof this._o.onClose&&this._o.onClose.call(this)}},destroy:function(){this.hide();w(this.el,"mousedown",this._onMouseDown,
...
$.fn.pikaday=function(){var a=arguments;a&&a.length||(a=[{}]);return this.each(function(){var c=$(this),b=c.data("pikaday");b instanceof Pikaday?"string"===typeof a[0]&&"function"===typeof b[a[0]]&&(b[a[0]].apply(b,Array.prototype.slice.call(a,1)),"destroy"===a[0]&&c.removeData("pikaday")):"object"===typeof a[0]&&(b=$.extend({},a[0]),b.field=c[0],c.data("pikaday",new Pikaday(b)))})};